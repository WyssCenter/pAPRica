...
tiles_autofluo = pipapr.parser.colmParser(path=path, channel=0)
tiles_nissl = pipapr.parser.colmParser(path=path, channel=1)
...
stitcher_expected = pipapr.tileStitcher(tiles_nissl, overlap_h=20, overlap_v=20)
...
stitcher_autofluo = pipapr.channelStitcher(tiles_nissl, overlap_h=20, overlap_v=20)
...
stitcher_autofluo = pipapr.tileStitcher(tiles_autofluo, overlap_h=20, overlap_v=20)
...
viewer = pipapr.tileViewer(tiles_autofluo, stitcher_autofluo.database)
